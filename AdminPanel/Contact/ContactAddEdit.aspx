...
<asp:Content ID="Content2" ContentPlaceHolderID="cphMainContent" Runat="Server">
    <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <asp:DropDownList ID="ddlStateID" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlStateID_SelectedIndexChanged" CssClass="form-control"></asp:DropDownList>
